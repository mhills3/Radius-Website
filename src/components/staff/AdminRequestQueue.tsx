...
import { QueuePage, SectionLabel, Card, CardGrid, CardTitle, Tag, Fact, Requester, ActionRail, Spinner, Empty, LoadError, fmtAgo } from "./QueueShell";
...
function RequestCard({ r, onResolved }: { r: AdminRequest; onResolved: (id: string) => void }) {
