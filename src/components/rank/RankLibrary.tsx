...
export default function RankLibrary({ currentTier, onClose }: { currentTier?: string; onClose: () => void }) {
  useEffect(() => {
      ...
      <div className="relative max-h-[88vh] w-full max-w-lg overflow-y-auto rounded-3xl border border-white/10 bg-[var(--bg-mid)] p-7 animate-[fadeIn_0.25s_ease]">
        <div className="flex items-start justify-between">
          <div>
            ...
            <h2 className="mt-1 font-[family-name:var(--font-heading)] text-2xl font-extrabold tracking-tight text-[var(--cream)]">From Rec to MPO</h2>
            <p className="mt-1 text-sm text-[var(--text-body)]">Your Game IQ earns a rank across 6 tiers — 30 ranks in all.</p>
          </div>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="ml-auto shrink-0 text-xs font-semibold text-[var(--sage-dim)]">{t.iqMin}–{t.iqMax} IQ</span>
                  </div>
