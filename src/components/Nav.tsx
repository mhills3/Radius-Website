...
export default function Nav() {
  ...
  const darkPage = pathname === "/dashboard" || pathname === "/bag" || pathname === "/notifications" || pathname === "/community" || pathname.startsWith("/community/") || pathname === "/courses/mine" || pathname === "/courses/new" || pathname.startsWith("/u/") || pathname.startsWith("/leagues"); // app surfaces are dark
