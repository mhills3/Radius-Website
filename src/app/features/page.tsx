  ...
  return (
    <div className="bg-[var(--bg-deep)] text-[var(--cream)]">
      ...
      <section className="relative isolate flex min-h-[94vh] items-center overflow-hidden">
        <Image src="/course/forehand.jpg" alt="" fill sizes="100vw" quality={80} className="-z-10 object-cover object-center opacity-[0.18]" priority />
        <div className="pointer-events-none absolute inset-0 -z-10 bg-[linear-gradient(115deg,rgba(11,17,13,0.97)_0%,rgba(11,17,13,0.86)_45%,rgba(11,17,13,0.66)_100%)]" />
        <div className="pointer-events-none absolute -left-40 top-0 -z-10 h-[720px] w-[720px] rounded-full bg-[radial-gradient(circle,rgba(246,193,101,0.14),transparent_62%)]" />
        <div className="pointer-events-none absolute -right-32 bottom-0 -z-10 h-[640px] w-[640px] rounded-full" style={{ background: `radial-gradient(circle, ${GREEN}22, transparent 62%)` }} />

        <div className="relative mx-auto grid w-full max-w-7xl items-center gap-12 px-6 pb-12 pt-24 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="text-center lg:text-left">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/[0.05] px-4 py-1.5 text-[11px] font-bold uppercase tracking-[0.18em] text-[var(--gold)] backdrop-blur">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-[var(--sage)] lg:justify-start">
              <span className="inline-flex items-center gap-1.5" style={{ color: GREEN }}>✓ <span className="text-[var(--sage)]">Free to start</span></span>
              <span className="inline-flex items-center gap-1.5" style={{ color: GREEN }}>✓ <span className="text-[var(--sage)]">iOS · Android · Web · Watch</span></span>
              <span className="inline-flex items-center gap-1.5" style={{ color: GREEN }}>✓ <span className="text-[var(--sage)]">Built by disc golfers</span></span>
            </div>
          </div>

          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              <div className="pointer-events-none absolute inset-0 -z-10 scale-125 rounded-full" style={{ background: `radial-gradient(circle, ${GREEN}33, transparent 60%)` }} />
              <PhoneFrame className="w-[268px] rotate-[2deg] sm:w-[312px]">
